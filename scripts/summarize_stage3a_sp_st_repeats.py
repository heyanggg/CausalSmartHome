...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser("Summarize SP-ST Stage 3A repeat robustness runs")
    parser.add_argument(
        "--run",
        action="append",
        default=[],
    ...
    parser.add_argument("--out-csv", type=Path, default=OUT_ROOT / "sp_st_codex_calibrated_multiseed_stage3a_summary.csv")
    parser.add_argument("--out-json", type=Path, default=OUT_ROOT / "sp_st_codex_calibrated_multiseed_stage3a_summary.json")
    parser.add_argument("--out-md", type=Path, default=OUT_ROOT / "sp_st_codex_calibrated_multiseed_stage3a_summary.md")
...
def main() -> None:
    ...
    for item in runs:
        ...
        summary_csv = OUT_ROOT / tag / "sp_st_stage3a_summary.csv"
